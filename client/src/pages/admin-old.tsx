...
import { Plus, Edit2, Trash2, Upload, Save, X, Eye, Calendar, MapPin, Monitor } from "lucide-react";
...
import type { Puppy, InsertPuppy, Visitor } from "@shared/schema";
...
export default function Admin() {
  ...
  const { data: visitors, isLoading: isLoadingVisitors } = useQuery<Visitor[]>({
